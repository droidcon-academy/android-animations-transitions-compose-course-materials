...
fun AnimateAsStateSheet() {
    Column(
        ...
        val cornerSize by animateDpAsState(
            //Target value for animation based on state
            targetValue = if (selected) 64.dp else 0.dp,

            //Label to be used in the Compose tooling animation preview
            label = "Corner",
        ...
        /**
         * Animated scale used for scaling
         */
